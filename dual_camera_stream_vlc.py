...
class RTSPCamera:
    def __init__(self, name, rtsp_url, model):
        self.name = name
        # Overwrite RTSP URL with the provided one for both cameras
        if name == "Cam1":
            self.rtsp_url = "rtsp://admin:BSECE-3A@192.168.0.11:554/Streaming/Channels/101"
        elif name == "Cam2":
            self.rtsp_url = "rtsp://admin:BSECE-3A@192.168.0.11:554/Streaming/Channels/201"
        else:
